    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
        <div className='max-w-2xl sm:py-6 mx-auto'>
            <div className='bg-white rounded-lg shadow p-6'>
                <h1 className='text-2xl font-bold text-gray-900 mb-6'>Chỉnh sửa thông tin</h1>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        rows={3}                       
                        className='w-full p-3 border border-gray-200 rounded-lg'
                        placeholder='Nhập thông tin trang cá nhân'
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        type='button' 
                        className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Hủy</button>
                        <button 
                        type='submit' 
                        className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 
                        hover:to-purple-700 transition cursor-pointer'>Cập Nhật</button>
                    </div>
                </form>
            </div>
        </div>
